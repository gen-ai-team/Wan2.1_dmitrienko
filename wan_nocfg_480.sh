...
torchrun --master_port=1224 --nproc_per_node=8 generate_v3.py  \
    ...
    --sample_steps 50 --sample_guide_scale 1 --sample_shift 5 \
    --start_prompt_i 0 \
    --n_prompts 100 \
    ...
    --save_dir /home/jovyan/dmitrienko/workspace/outputs/WAN/nocfg/t2v_50steps_81frames_5gs_5sh_seed5575 \
    --model_ckpt_path /home/jovyan/dmitrienko/workspace/checkpoints/pretrained/wan_cfg_synthetic_lora_v1_step_7199
